...
/** CONFIG */
const PHONE_E164 = "+584248190169";                 // Tel para "Llamar"
const WA_NUMBER = "584248190169";                   // Solo dígitos
const CONTACT_EMAIL = "haymarmarcano@gmail.com";    // Email visible
const FORM_EMAIL = "drahaymarmarcano@gmail.com";    // Email que recibe formulario
const MAPS_URL = "https://maps.google.com/?q=Consultorio%20Dra%20Haymar"; // Reemplaza por el real
const CHAT_URL = "";                                // URL de tu chat (si aplica)
      ...
      <section id="consulta" className="bg-neutral-50">
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          <p className="mt-2 max-w-2xl text-[#3a3a3c]">
            Atención pediátrica presencial (según disponibilidad). Te indicamos preparación previa por WhatsApp o llamada.
          </p>
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <div className="card-pro p-6">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <a href={WA_LINK} className="btn btn-primary btn-pulse" onMouseMove={pulse} target="_blank" rel="noopener noreferrer">WhatsApp</a>
              <a href={TEL_LINK} className="btn btn-outline">Llamar</a>
              <button onClick={openChat} className="btn btn-outline">Chat</button>
            </div>
          </div>
          ...
          <div className="card-pro p-6">
            ...
            <form className="mt-4 grid gap-3" action={FORM_ENDPOINT} method="POST">
              ...
              <textarea className="min-h-[110px] w-full rounded-xl border border-neutral-300 px-4 py-3 outline-none focus:ring-2 focus:ring-[#0f0f10]" name="Mensaje" placeholder="Tu mensaje" required />
